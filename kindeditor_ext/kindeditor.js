...
/******************************************************************************
	...
	1  写在开头, 定制Kindeditor , 为了完成跨域上传单张图片(对应其 image 插件),
	   在 Kindeditor 中追加 submitFile 方法 .
	2  为了维护简单 , 将相关代码移入到 jquery.xmupload.js 中.
...
_extend(KUploadButton, {
	...
	submitFile : function(prop) {
		var self = this,
			iframe = self.iframe;
			var $iframe = iframe[0];		

			var fileInput =  $("input[type=file]",self.form[0])[0];
